      ...
      <div className="min-h-[100px] rounded-lg sm:col-span-5">
        <div className="block w-full">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-6">
            ...
            <div className="min-h-[100px] rounded-lg sm:col-span-4 mt-1 flex -ml-10">
              <input type="checkbox" value="EPT/EPT" className="w-5 h-5 mt-1" />
              <label className="text-subtopic text-gray-700 ml-2">
                EPF/ETF
              </label>
            </div>
          </div>
